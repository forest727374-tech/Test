-- // KECUYA HUB (FULL FIXED & UPDATED EDITION)
...
-- ==========================================
-- 2. ИНТЕРФЕЙС (КОМПАКТНЫЙ 360x230)
-- ==========================================
      ...
      if Flags.AirRock then
         pcall(function()
            ...
            if char and char:FindFirstChild("HumanoidRootPart") then
               ...
               if targetRock then
                  -- Телепорт чуть выше камня (удар по воздуху)
                  hrp.CFrame = targetRock.CFrame * CFrame.new(0, targetRock.Size.Y / 2 + 4, 0)
...
-- ИСПРАВЛЕННЫЙ ПОЛЕТ (НЕ ШОТАЕТСЯ, СТОИТ НА МЕСТЕ + FLY SPEED)
   ...
   while true do
      pcall(function()
         ...
         if Flags.Fly and char and char:FindFirstChild("HumanoidRootPart") then
            ...
            -- Удержание на месте и управление
...
-- Вкладка: Защита (С НОВЫМИ ФУНКЦИЯМИ)
