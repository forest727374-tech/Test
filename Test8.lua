-- // MUSCLE LEGENDS ULTRA GALAXY HUB (EXCLUSIVE EDITION)
...
-- Функция Краша Клиента при неверном ключе
local function CrashGame()
   while true do end -- Зависание потока + перегрузка
end

-- ==========================================
-- 1. ЭЛИТНЫЙ ИНТЕРФЕЙС С АНИМАЦИЯМИ
-- ==========================================
...
KeySub.Position = UDim2.new(0, 0, 0, 32)
...
-- Плавное появление KeyFrame
TweenService:Create(KeyFrame, TweenInfo.new(0.5), {BackgroundTransparency = 0}):Play()
...
-- ==========================================
-- 3. СОЗДАНИЕ КРАСИВЫХ ВКЛАДОК И СВИТЧЕЙ
-- ==========================================
local Pages = {}
