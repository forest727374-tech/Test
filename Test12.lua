-- // MUSCLE LEGENDS ULTRA GALAXY HUB (DARK MINIMAL EDITION)
...
TabButtons[1]:FindFirstChild("Frame").Visible = true
...
CreateToggle(UtilityPg, "Anti-Knockback (Без отбрасывания)", function(v) Flags.AntiKnockback = v end)
CreateToggle(UtilityPg, "Закрепиться (Anchor)", function(v) Flags.AnchorPos = v end)
CreateToggle(UtilityPg, "Anti-AFK (Защита от вылета)", function(v) Flags.AntiAFK = v end)
