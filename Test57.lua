...
local CorrectKey = "kecuya-hub-key-2026"

local CoreGui = game:GetService("CoreGui")
local KeySystemGui = Instance.new("ScreenGui")
KeySystemGui.Name = "KeySystemUI"
...
Title.Text = "@kecuya Hub - Key System"
...
CheckBtn.Position = UDim2.new(0.2, 0, 0.72, 0)
CheckBtn.Size = UDim2.new(0.6, 0, 0, 35)
...
local Library = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/zxciaz/Kavo-UI-Library/main/source.lua"))()
local SaveManager = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Violent-S/SaveManager/main/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Violent-S/InterfaceManager/main/InterfaceManager.lua"))()

-- 🏠 Creation (Updated Title, SubTitle & Dark Theme Style)
local Window = Library:CreateWindow{
    Title = "@kecuya Hub",
    SubTitle = "Muscle Legends Automation",
    TabWidth = 125,
