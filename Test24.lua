-- // KECUYA HUB (SMOOTH NEON EDITION)
   ...
   while true do
      pcall(function()
         if Flags.AutoKillAir then
            for _, p in pairs(Players:GetPlayers()) do if p ~= LocalPlayer and not IsFriend(p) then AirHitPlayer(p) end end end
...
-- ИСПРАВЛЕННЫЙ ПОДВИЖНЫЙ FLY (SWIMMING STATE)
local flyBV, flyBG
task.spawn(function()
   while true do
      pcall(function()
