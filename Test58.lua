...
if not isWhitelisted then
    ...
    player:Kick("🚫 You are not allowed to use this script u faggot")
    return
end

local Library = loadstring(game:HttpGetAsync("https://[Log in to view URL]"))()
local SaveManager = loadstring(game:HttpGetAsync("https://[Log in to view URL]"))()
...
Tabs.Misc:CreateButton{
	...
	Callback = function()
		...
		local function GetSmallServer()
			local AllServers = game.HttpService:JSONDecode(game:HttpGet('https://[Log in to view URL]' .. PlaceID .. '/servers/Public?sortOrder=Asc&limit=100'))
