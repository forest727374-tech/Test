-- // MUSCLE LEGENDS ULTRA GALAXY HUB (REBIRTH CHECK EDITION)
...
-- Функция Мгновенного Краша при Неверном Ключе
...
local PetList = {
   "Cyber Dragon", "Dark Star", "Demon Hydra", "Gold Master", "Ice Monster", 
   "King Beast", "Fire Aura", "Ultra Bird", "Muscle Doge", "Galaxy Dragon",
   "Phoenix", "Void Dragon", "Neon Bunny", "Blue Fire", "Red Imp", "Shadow Raven"
}
...
-- ==========================================
-- 4. ВИТРИНЫ И ЭЛЕМЕНТЫ УПРАВЛЕНИЯ
-- ==========================================
local Pages = {}
...
-- Вкладка 4: Ребирт (ОБНОВЛЕННАЯ ВЕРСИЯ С ПРОВЕРКОЙ)
...
CreateToggle(RebirthPg, "🔄 ПРОВЕРКА РЕБИРТОВ", function(v)
